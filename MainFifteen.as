package ru
{
	...
	import ru.GridCells;
	import ru.gameFifteen.options.WindowOptions;
	import ru.gameFifteen.playGame.ControllerKey;
	import ru.gameFifteen.playGame.WindowGame;
	
	public class MainFifteen extends Sprite
	{
		...
		public function MainFifteen():void
		{
		...
		private function startGame(event:Event):void
		{
			...
			ValueApp.zeroCell = ValueApp.sideHor_XX * ValueApp.sideVer_YY;
			ValueApp.amountCells = ValueApp.sideHor_XX * ValueApp.sideVer_YY;
			ValueApp.step = 8;
			StepPlus.getInstance();
			ru.LanguageApp.getInstance();
